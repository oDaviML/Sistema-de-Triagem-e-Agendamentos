...
public class EmailService {
    ...
    public void agendamento(PacienteDTO paciente, ConsultaDTO consulta) {
        ...
        mensagem = "<!DOCTYPE html>"
            ...
            + "<p>A sua consulta para " + consulta.getEspecialidade() + " está agendada para o dia de " + formattedDate + " às " + consulta.getHorario() + " com " + consulta.getNomemedico() + ".</p>"
    ...
    public void cancelarConsulta(PacienteDTO pacienteDTO, ConsultaDTO consultaDTO) {
        ...
        String mensagem = "<!DOCTYPE html>"
                ...
                + "<p>Sua consulta agendada para o dia " + formattedDate + " às " + consultaDTO.getHorario() + " com  " + consultaDTO.getNomemedico() + " na especialidade de " + consultaDTO.getEspecialidade() + " foi cancelada com sucesso.</p>"
