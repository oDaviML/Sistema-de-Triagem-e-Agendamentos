...
const COMANDOS_DE_VOZ = {
    acessoMedico: ['login', 'loginmedico', 'entrar'],
    acessoCadastroMedico: ['cadastro', 'cadastrar', 'cadastromedico'],
...
class Bando {
        ...
        microfoneEl.addEventListener('click', e => {
            ...
            if (animatedEl.classList.contains('listening')) {
                ...
                this.reconhecimento = inicializaReconhecimentoDeFala({
                    acessoMedico: this.medico.bind(this),
                    acessoCadastroMedico: this.cadastro.bind(this),
    ...
    cadastro() {
        window.location.href = "cadastroFunc.xhtml";
    }
